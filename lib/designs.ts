...
const imagePresets: Array<{ key: string; label: string; fg: string; bg: string }> = [
  ...
  { key: '11', label: 'Blush', fg: '#1F1F1F', bg: '#ffcad3' },
  { key: '12', label: 'Sprout', fg: '#1F1F1F', bg: '#e0f8d1' },
  { key: '13', label: 'Cloud', fg: '#1F1F1F', bg: '#e8ecff' },
  { key: '14', label: 'Petal', fg: '#1F1F1F', bg: '#ffe8f2' },
  { key: '15', label: 'Peach', fg: '#1F1F1F', bg: '#fff0e8' },
  { key: '16', label: 'Fog', fg: '#1F1F1F', bg: '#f0f0f0' },
  { key: '17', label: 'Sky', fg: '#1F1F1F', bg: '#e8f5ff' },
  { key: '18', label: 'Frost', fg: '#1F1F1F', bg: '#f1fbf8' },
  { key: '19', label: 'Rose', fg: '#1F1F1F', bg: '#ffcdd5' },
  { key: '20', label: 'Meadow', fg: '#1F1F1F', bg: '#e2f8d3' },
  { key: '21', label: 'Mist', fg: '#1F1F1F', bg: '#e9edff' },
  { key: '22', label: 'Bloom', fg: '#1F1F1F', bg: '#ffe9f3' },
  { key: '23', label: 'Sand', fg: '#1F1F1F', bg: '#fff1e9' },
  { key: '24', label: 'Ash', fg: '#1F1F1F', bg: '#f1f1f1' },
  { key: '25', label: 'Breeze', fg: '#1F1F1F', bg: '#e9f6ff' },
  { key: '26', label: 'Glacier', fg: '#1F1F1F', bg: '#f1fbf8' },
  { key: '27', label: 'Pebble', fg: '#1F1F1F', bg: '#f1f6f9' },
  { key: '28', label: 'Coral', fg: '#1F1F1F', bg: '#fae4e3' },
  { key: '29', label: 'Dew', fg: '#1F1F1F', bg: '#e7eff5' },
  { key: '30', label: 'Linen', fg: '#1F1F1F', bg: '#fdf4f2' },
  { key: '31', label: 'Sage', fg: '#1F1F1F', bg: '#f4f8f0' },
  { key: '32', label: 'Powder', fg: '#1F1F1F', bg: '#f9f4f8' },
  { key: '33', label: 'Candy', fg: '#1F1F1F', bg: '#ffddf0' },
  { key: '34', label: 'Aqua', fg: '#1F1F1F', bg: '#dcf1ff' },
  { key: '35', label: 'Cotton', fg: '#1F1F1F', bg: '#faf9f8' },
  { key: '36', label: 'Willow', fg: '#1F1F1F', bg: '#f4f8f2' },
  { key: '37', label: 'Lime', fg: '#1F1F1F', bg: '#f5fbcc' },
  { key: '38', label: 'Apricot', fg: '#1F1F1F', bg: '#ffe0d2' },
  { key: '39', label: 'Violet', fg: '#1F1F1F', bg: '#dbd6ff' },
  { key: '40', label: 'Flamingo', fg: '#1F1F1F', bg: '#ffd3e7' },
  { key: '41', label: 'Lilac', fg: '#1F1F1F', bg: '#f6f2f8' },
  { key: '42', label: 'Orchid', fg: '#1F1F1F', bg: '#f7ecf3' },
  { key: '43', label: 'Wisteria', fg: '#1F1F1F', bg: '#f3e3f8' },
  { key: '44', label: 'Clay', fg: '#1F1F1F', bg: '#e8dbd8' },
  { key: '45', label: 'Blossom', fg: '#1F1F1F', bg: '#fcdcf4' },
  { key: '46', label: 'Sea Glass', fg: '#1F1F1F', bg: '#ecf4f1' },
  { key: '47', label: 'Oat', fg: '#1F1F1F', bg: '#eeebe4' },
];
